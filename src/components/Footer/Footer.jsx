...
const Footer = () => {
  ...
  const programs = [
    { name: t("Primary School"), href: "#" },
    { name: t("Middle School"), href: "#" },
    { name: t("High School"), href: "#" },
    { name: t("International Baccalaureate"), href: "#" },
    { name: t("Summer Programs"), href: "#" },
  ];

  const resources = [
    { name: t("Student Portal"), href: "#" },
    { name: t("Parent Portal"), href: "#" },
    { name: t("Calendar"), href: "#" },
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              {t(
                "Shaping global citizens through excellence in international education since 1995. Preparing students for success in an interconnected world."
              )}
            </p>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-slate-100 hover:bg-blue-600 text-slate-600 hover:text-white rounded-lg flex items-center justify-center transition-all duration-300 group"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-slate-600 text-sm">
                  ...
                  <p>Alexandria, Teleorman County</p>
                  <p>Romania</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-slate-600 text-sm">+40 123 456 789</span>
              </div>
            ...
            <ul className="space-y-2">
              {resources.map((resource, index) => (
                <li key={index}>
                  ...
                  >
                    <svg
                      className="w-3 h-3 mr-2 text-slate-400 group-hover:text-blue-600 transition-colors"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 mb-12 border border-blue-100">
          <div className="text-center mb-6">
            ...
            <p className="text-slate-600">
              {t("Subscribe to our newsletter for the latest news and updates")}
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            />
            <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
              <svg
        ...
        <div className="pt-8 border-t border-slate-200">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-slate-600 text-sm">
              © 2025 International School. {t("All rights reserved.")}
            </div>
